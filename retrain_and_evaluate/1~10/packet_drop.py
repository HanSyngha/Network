...
save_path = "/media/0/Network/extracted_feature/whole_shuffle_to_19/with_"+str(drop_num)+"_packet_error/"
...
concatenate(train_label,"train_label_"+str(drop_num)) # saved
