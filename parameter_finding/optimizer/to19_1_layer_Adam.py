...
f = open("result_back_1_Adam.txt","w")
f.close()
for val_lr in [0.1,0.005,0.001,0.0001,0.00005]:
    print("lr :",val_lr)
    ...
    optimizer = tf.keras.optimizers.Adam(lr=val_lr,beta_1=0.9,beta_2=0.999,epsilon=None, decay=0,amsgrad=False)
    ...
    for i in tqdm(range(10)):
        ...
        #f = open("result_back_1_adadelta.txt","w")
        f = open("result_back_1_Adam.txt","a")
