...
#print(front_layers.summary())

print("start reading image file")
...
np.save("/media/2/Network/extracted_feature/whole_shuffle/train_features_0",train_features)
np.save("/media/2/Network/extracted_feature/whole_shuffle/train_label_0",train_label)
