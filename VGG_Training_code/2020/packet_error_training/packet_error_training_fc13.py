...
for Packet_index in range(0,(65-Packet_number_to_erase)):
    if os.path.exists("/media/1/Network/VGG16/weights/fc/13/"+str(Packet_index+1)+"_10.h5"):
        continue
    ...
    for Epoch in range(1,11):
        file_name = "/media/1/Network/VGG16/weights/fc/13/"+str(Packet_index+1)+"_"+str(Epoch)+".h5"
